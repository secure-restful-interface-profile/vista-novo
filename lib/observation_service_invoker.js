  ...
  if (model === 'observation' && typeof req.params.id !== "undefined") {
    ...
    ResourceHistory.findInCacheOrLocal(observationId, 'Observation', function(resourceHistory) {
      ...
      // } else {
        ...
        restler.get(requestUrl, {headers: {'Authorization': req.header['authorization']}}).once('complete', function(vistaObservation) {
          if (vistaObservation.statusCode >= 200 && vistaObservation.statusCode < 300) {
            ...
            res.send(vistaObservation.statusCode);
          }       
        });
      // }
    });
